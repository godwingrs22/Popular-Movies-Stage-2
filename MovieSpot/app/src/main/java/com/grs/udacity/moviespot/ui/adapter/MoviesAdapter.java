package com.grs.udacity.moviespot.ui.adapter;
...
import com.grs.udacity.moviespot.utils.UiUtils;
...
/**
 * Created by GodwinRoseSamuel on 24-Dec-16.
 */
public final class MoviesAdapter extends EndlessAdapter<Movie, MoviesAdapter.MovieHolder> {
    ...
    final class MovieHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(@NonNull final Movie movie) {
            ...
            mReleaseDateView.setText(UiUtils.getDisplayReleaseDate(movie.getReleaseDate()));
        ...
        private void resetColors() {
            ...
            mReleaseDateView.setTextColor(mColorSubtitle);
        ...
        private void applyColors(Palette.Swatch swatch) {
            if (swatch != null) {
                ...
                mReleaseDateView.setTextColor(swatch.getBodyTextColor());
